...
基础连接：[文字如何变成数字](../../01-14天理论课/D02-文字如何变成数字.md)、[拼出完整 Transformer](../../01-14天理论课/D06-拼出完整Transformer.md)。多模态系统上线后的质量、任务、安全与服务监控，接回[D14：监控、反馈与持续迭代](../../01-14天理论课/D14-监控、反馈与持续迭代.md)。
