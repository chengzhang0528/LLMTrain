...
| [GLM 系列演进](04-GLM系列演进.md) | GLM 从预训练目标走到 Agent 和稀疏注意力经历了什么？ | 一条主干与能力分支路线 |
| [Kimi 系列演进](05-Kimi系列演进.md) | Kimi 如何把 RL、MoE、混合注意力和原生多模态串起来？ | 一条架构/训练/系统联合路线 |
| [DeepSeek 系列演进](06-DeepSeek系列演进.md) | DeepSeek 如何在 MoE、推理 RL、视觉和验证器之间扩展？ | 一张问题到证据地图 |
| [Qwen 系列演进](07-Qwen系列演进.md) | Qwen 如何从通用文本扩展到代码、数学、视觉、音频和安全？ | 一张多分支路线 |

已经具备阅读基础后，再进入[Kimi K3 技术报告深读](../Kimi-K3深读/)或[在策略蒸馏论文深读](../在策略蒸馏深读/)；它们是完整案例，不是论文目录的替代品。
