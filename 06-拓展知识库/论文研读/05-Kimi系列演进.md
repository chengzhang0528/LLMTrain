...
> **怎么读**：先进入[Kimi k1.5：长思维链强化学习](Kimi深读/01-k1.5长思维链强化学习.md)，再读 MoBA、K2、Kimi Linear、K2.5 和[Kimi K3 技术报告](Kimi深读/06-Kimi-K3技术报告.md)。K3 仍是一篇论文，只是报告密度较高，因此在单篇课内再拆成六个子课。
...
[Kimi K3 技术报告](Kimi深读/06-Kimi-K3技术报告.md)用一篇总览和六个子课拆解信息流、KDA、AttnRes、LatentMoE、预训练、多模态、后训练和评测。先完成前五篇，再进入 K3，更容易看清哪些设计来自此前路线，哪些是新的组合证据。
