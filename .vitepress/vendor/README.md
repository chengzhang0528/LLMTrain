# Vendored visualization runtimes

These browser-only ESM files keep course diagrams available without a runtime network request.

| File | Version | Upstream | License |
|---|---:|---|---|
| `rough.esm.js` | 4.6.6 | <https://github.com/rough-stuff/rough> | MIT |
