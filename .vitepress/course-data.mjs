...
const supportGroups = [
  {
    ...
    items: [
      ...
      ["外积与状态矩阵", "/03-数学急救包/06-外积与状态矩阵"],
      ["分位数与平滑封顶", "/03-数学急救包/07-分位数与平滑封顶"]
    ]
  },
  {
    text: "图解与数字漫画",
  ...
  },
  {
    ...
    collapsed: true,
    items: [
      ["路线说明", "/06-拓展知识库/Kimi-K3深读/"],
      ["审技术报告", "/06-拓展知识库/Kimi-K3深读/01-先学会审技术报告"],
      ["三维信息流", "/06-拓展知识库/Kimi-K3深读/02-三维信息流全景"],
      ["KDA 与混合注意力", "/06-拓展知识库/Kimi-K3深读/03-KDA与混合注意力"],
      ["AttnRes 与 LatentMoE", "/06-拓展知识库/Kimi-K3深读/04-AttnRes与Stable-LatentMoE"],
      ["预训练与多模态", "/06-拓展知识库/Kimi-K3深读/05-预训练长上下文与原生多模态"],
      ["后训练与可验证 RL", "/06-拓展知识库/Kimi-K3深读/06-后训练与可验证RL"],
      ["基础设施与评测", "/06-拓展知识库/Kimi-K3深读/07-基础设施与评测"]
    ]
  },
  {
    text: "来源与审计",
